            ...
            <div class="mt-5 md:mt-0 md:col-span-1 bg-main-fund items-center w-2/4">
                <div class="shadow rounded-md sm:overflow-hidden">
                    <div class="px-4 py-5 space-y-6 sm:p-6 w-full">
                        ...
                        @if($editing)
                        <div class="col-span-6 sm:col-span-3 my-9">
                        ...
                        <div class="col-span-6 sm:col-span-3 mt-9">
                            ...
                            <input wire:model='lastname' require type="text" placeholder="{{ $user->lastname }}" name="lastname" id="lastname" class="leading-snug border border-gray-400 block w-3/4 appearance-none bg-white text-gray-700 py-1 px-4 w-full rounded mx-auto">
                        </div>
                        @endif
                        <div class="col-span-6 sm:col-span-3 mt-9">
                        ...
                        <div class="col-span-6 sm:col-span-3 mt-9">
                            ...
                            @else
                            <input wire:model.defer='email' require placeholder="{{ $user->email }}" type="email" autofocus="autofocus" class="leading-snug border border-gray-400 block w-3/4 appearance-none bg-white text-gray-700 py-1 px-4 w-full rounded mx-auto">
