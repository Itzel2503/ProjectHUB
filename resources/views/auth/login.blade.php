...
<div class="relative min-h-screen flex flex-col sm:justify-center items-center">
    <div class="relative sm:max-w-sm w-full">
        <div class="relative w-full rounded-lg px-6 py-4 bg-gray-300 shadow-md">
            ...
            <div class="py-2">
                <label for="" class="block mt-3 text-lg  text-center font-semibold">Inicia sesión</label>
            </div>
            <br>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input type="password" name="password" id="password" class="block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-2 border-black appearance-none dark:text-black dark:border-black dark:focus:border-black focus:outline-none focus:ring-0 focus:border-black peer" placeholder=" " required autocomplete="current-password" />
                ...
                <div class="mt-14 mb-16">
                    <button type="submit" class="bg-teal-600 w-full py-3 rounded-xl text-white font-bold shadow-xl hover:shadow-scale-110 hover:bg-teal-500 transition">
                        Ingresar
                    </button>
                </div>
