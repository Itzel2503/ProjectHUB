...
<div class="relative h-screen flex flex-col justify-center items-start lg:ml-40 mx-5 sm:mx-10 py-5 sm:py-12">
    <div class="relative w-full h-full flex items-center">
        <div class="relative w-full sm:w-1/2 md:w-2/5 lg:w-1/3 xl:w-1/4 px-5 sm:px-14 py-10 sm:pt-14 bg-white shadow-md" style="border-radius: 150px; border-bottom-right-radius: 20px;">
            <div>
