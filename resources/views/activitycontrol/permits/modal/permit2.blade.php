    ...
    <div class="md:w-1/2 flex flex-col px-3 mb-6 md:mb-0">
        ...
        <div class="relative z-0 w-full group flex justify-between items-center">
            <select required name="take_hours" id="take_hours" class="leading-snug border border-gray-400 block w-1/4 appearance-none bg-white text-gray-700 py-1 px-4 w-full rounded mx-auto">
                ...
                @endforeach
                <option valur="other">Otro</option>
            </select>
            <input type="text" name="take_hours" id="take_hours" class="leading-snug border border-gray-400 block appearance-none bg-white text-gray-700 py-1 px-4 w-full rounded mx-auto">
        </div>
    </div>
</div>
<div class="-mx-3 md:flex mb-6">
