...
<body>
    <div id="container"  class="flex h-screen">
            ...
            <div class="bg-secondary-fund py-1" style="height:100%">
                ...
                <form method="POST" action="{{ route('logout') }}" x-data>
                    ...
                    <div class="text-center pt-20">
                        <span class="text-base font-semibold text-yellow">
                            <button value="Log out" type="submit" class="bg-transparent text-yellow font-semibold py-2 px-4 border border-yellow dark:border-yellow rounded hover:text-white hover:border-white">
        ...
        <div x-data="{ open: false }" class="md:hidden block bg-secondary-fund">
            ...
            <div class="py-4 w-full z-40 absolute shadow-md text-white bg-secondary-fund transform -translate-x-full transition-transform duration-300" x-show="open" @click.outside="open = false">
                <ul>
                    <li class="relative px-6 py-3">
                        @yield('profile')
                        <a class="w-full inline-flex text-white hover:text-yellow transition-colors duration-150 text-base font-semibold @yield('black1')" href="{{ route('profile.index' ) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user-circle" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                <path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" />
                                <path d="M12 10m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0" />
                    ...
                    <li class="relative px-6 py-3">
                        @yield('userCatalog')
                        <a class="w-full inline-flex text-white hover:text-yellow transition-colors duration-150 text-base font-semibold @yield('black2')" href="{{ route('userCatalog.index') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-users-group" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                <path d="M10 13a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" />
                                <path d="M8 21v-1a2 2 0 0 1 2 -2h4a2 2 0 0 1 2 2v1" />
                                <path d="M15 5a2 2 0 1 0 4 0a2 2 0 0 0 -4 0" />
                    ...
                    <li class="relative px-6 py-3">
                        @yield('customers')
                        <a class="w-full inline-flex text-white hover:text-yellow transition-colors duration-150 text-base font-semibold @yield('black3')" href="{{ route('customers.index') }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-users" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                <path d="M9 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" />
                                <path d="M3 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" />
                    ...
                    <li class="relative px-6 py-3">
                        <form method="POST" action="{{ route('logout') }}" x-data>
                            @csrf
                            <button value="Log out" type="submit" class="text-white inline-flex items-center w-full text-base font-semibold transition-colors duration-150 hover:text-yellow">
