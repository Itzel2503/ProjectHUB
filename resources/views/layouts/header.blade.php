...
<body>
    <div class="flex h-screen" :class="{ 'overflow-hidden': isSideMenuOpen }">
        <!-- Desktop sidebar -->
        <div class="z-20 hidden w-64 overflow-y-auto md:block flex-shrink-0 shadow-md">
            <div class="bg-secondary-fund py-1" style="height:100%">
                ...
                <ul class="mt-6">
                    ...
                    <li class="relative px-6 py-3">
                        ...
                        <a class="text-white inline-flex items-center w-full text-base font-semibold transition-colors duration-150 hover:text-yellow  @yield('black4')" href="">
